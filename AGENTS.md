...
3. 항상 최신 `main`에서 분기하고 모든 PR의 base를 `main`으로 지정한다. stacked PR은 만들지 않는다.
...
10. 브랜치를 `origin`에 push하고 반드시 `main` 대상 PR을 생성한다. PR 본문에는 변경 요약, `CHANGE.md` 항목과 실행한 검증을 기록한다.
